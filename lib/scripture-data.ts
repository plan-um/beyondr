...
export const chapters: ScriptureChapter[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    theme: 'awakening',
    intro_ko:
      '깨어남은 어딘가에 도착하는 것이 아니다.\n이미 여기 있는 것을, 다시 보는 것이다.',
    intro_en:
    ...
    verses: [
      {
        ...
        reflection_ko: '눈을 감으면, 거기서 무엇을 만나는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 2,
        text_ko:
          '그 보는 자를 찾았다면, 생각을 멈추려 애쓰지 말라.\n강물을 막으면 넘치듯이.\n그냥 바라보라. 생각은 지켜볼 때 스스로 고요해진다.',
        text_en:
        ...
        reflection_ko: '지금 떠오르는 생각을, 싸우지 않고 바라볼 수 있는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 3,
        text_ko:
          '바라보는 법을 알았다면, 이제 멀리 갈 필요 없다.\n오늘 아침 마신 물 한 잔, 거기에 깨어남이 있다.',
        text_en:
      ...
      },
      {
        ...
        verse: 4,
        text_ko:
          '물 한 잔에서도 깨어남을 느꼈다면, 이제 더 깊이 들어가라.\n세상이 시끄러울수록, 내 안은 더 고요해져야 한다.\n깊은 바다는 수면의 폭풍을 모른다.',
        text_en:
        ...
        reflection_ko: '지금 내 안은 얼마나 깊은 곳에 있는가?',
      ...
      },
      {
        ...
        reflection_ko: '나를 찾으려는 그 마음은, 어디에서 왔는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 6,
        text_ko:
          '하지만 찾겠다는 빛만으로는 부족하다.\n아는 것과 사는 것 사이에는 간격이 있다.\n그 간격을 줄여가는 것, 그것이 수행이다.',
        text_en:
      ...
      },
      {
        ...
        reflection_ko: '오늘 5분만 멈춰본다면, 무엇이 보이겠는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 8,
        text_ko:
          '멈추고 보면, 종교 너머의 것이 보인다.\n종교 없이 태어날 수는 있어도, 자비 없이 태어나는 사람은 없다.\n자비야말로 모든 가르침의 시작이다.',
        text_en:
      ...
      },
      {
        ...
        reflection_ko: '지금 꼭 쥐고 있는 것 중에, 놓아줄 수 있는 것은 무엇인가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 10,
        text_ko:
          '놓아줄수록, 경계가 사라진다.\n나와 우주가 따로 있다는 느낌은 착각이다.\n깊이 보면, 나는 우주가 스스로를 표현하는 한 방식이다.',
        text_en:
        ...
        reflection_ko: '나와 세상 사이에, 진짜 경계가 있는가?',
        reflection_en:
      ...
      },
      {
        ...
        reflection_ko: '깨어남을 위해, 오늘 연습할 수 있는 작은 것은 무엇인가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 12,
        text_ko:
          '그 연습의 첫걸음은 간단하다.\n잠깐 멈추고, 숨을 깊이 쉬라.\n세상이 나를 흔들어도, 내 마음이 동의하지 않으면 흔들리지 않는다.\n너의 마음은, 너의 것이다.',
        text_en:
        ...
        reflection_ko:
          '최근에 흔들렸을 때, 내 마음이 먼저 동의하지는 않았는가?',
        reflection_en:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    theme: 'suffering',
    intro_ko:
      '누구나 아프다.\n하지만 아픔을 끝까지 통과한 자는, 전에 없던 빛을 품게 된다.',
    intro_en:
    ...
    verses: [
      {
        ...
        verse: 1,
        text_ko:
          '고통은 벌이 아니다.\n고통은 질문이다. "지금, 나에게 정말 중요한 것은 무엇인가?"',
        text_en:
        ...
        reflection_ko: '지금 내 고통이 묻고 있는 질문은 무엇인가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 2,
        text_ko:
          '그 질문 앞에서 우리는 부러진다.\n하지만 부러진 뼈가 더 단단해지듯, 부러진 마음도 더 넓어질 수 있다.',
        text_en:
        ...
        reflection_ko: '내가 부러진 곳은 어디이고, 거기서 어떤 빛이 들어오는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 3,
        text_ko:
          '넓어지려면 먼저 질문을 바꿔야 한다.\n"왜 하필 나에게?"가 아니라, "이것이 나에게 무엇을 가르치고 있는가?"라고.',
        text_en:
        ...
        reflection_ko: '최근 어려움이 내게 가르쳐준 것이 있다면 무엇인가?',
      ...
      },
      {
        ...
        verse: 4,
        text_ko:
          '배움이 시작되면, 눈물이 나올 수 있다.\n그것은 약한 것이 아니다. 얼어붙은 땅이 녹을 때 물이 흐르는 것이다.',
        text_en:
        ...
        reflection_ko: '마지막으로 눈물을 흘린 것은 언제인가? 그때 무엇이 녹았는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 5,
        text_ko:
          '눈물이 마르면 치유가 시작된다.\n치유는 잊는 것이 아니다. 기억하면서도 평화로울 수 있다는 것을 배우는 것이다.',
        text_en:
        ...
        reflection_ko: '기억하면서도 고요할 수 있는 상처가 있는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 6,
        text_ko:
          '평화롭게 기억할 수 있게 되면, 그 상처는 문이 된다.\n내 아픔을 통과한 만큼, 다른 사람의 아픔에 닿을 수 있으니.',
        text_en:
        ...
        reflection_ko: '내 아픔이 누군가에게 위로가 된 적이 있는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 7,
        text_ko:
          '다른 사람의 아픔에 닿으려면, 먼저 내 아픔을 피하지 않아야 한다.\n고통을 피하면 커지지만, 안아주면 달라진다.',
        text_en:
        ...
        reflection_ko: '지금 피하고 있는 고통이 있다면, 오늘 살짝 안아줄 수 있겠는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 8,
        text_ko:
          '안아주고 나면, 밤이 조금씩 걷힌다.\n가장 깊은 밤 뒤에 새벽이 오듯, 가장 깊은 고통 뒤에 이해가 찾아온다.',
        text_en:
        ...
        reflection_ko: '가장 힘들었던 시간이 결국 내게 준 선물은 무엇이었는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 9,
        text_ko:
          '새벽이 와도 무력감이 남을 수 있다.\n하지만 기억하라. 무력감을 키우는 것은 고통이 아니라, "나는 이것을 바꿀 수 없다"는 생각이다.',
        text_en:
      ...
      },
      {
        ...
        verse: 10,
        text_ko:
          '바꿀 수 있다는 믿음이 돌아오면, 비로소 보인다.\n모든 전통이 말해온 하나의 진리가. 고통에는 끝이 있고, 그 끝에는 이해가 있다는 것을.',
        text_en:
        ...
        reflection_ko: '고통의 끝에서 이해하게 된 것이 있는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 11,
        text_ko:
          '그 이해 안에서 깨닫게 된다.\n사랑과 고통은 한 쌍이라는 것을. 사랑하지 않으면 아프지 않고, 아파보지 않으면 깊이 사랑할 수 없다.',
        text_en:
        ...
        reflection_ko: '내 가장 큰 아픔은, 가장 큰 사랑과 이어져 있는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 12,
        text_ko:
          '그러니 고통 앞에서 도망치지 말라.\n존엄하게 견디는 것이, 수치스럽게 기쁨을 쫓는 것보다 낫다.\n그것이 고통을 통과한 자의 빛이다.',
        text_en:
        ...
        reflection_ko: '고통 앞에서, 나는 존엄을 지킬 수 있는가?',
        reflection_en:
    ...
    verses: [
      {
        ...
        reflection_ko: '내가 사랑하는 사람을, 고치려 하지 않고 바라본 적이 있는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 2,
        text_ko:
          '그런데 누군가를 있는 그대로 보려면,\n먼저 나를 있는 그대로 볼 수 있어야 한다.\n자기 안에 뿌리 내리지 못한 사랑은 오래가지 못한다.',
        text_en:
        ...
        reflection_ko: '나 자신을, 있는 그대로 바라보고 있는가?',
        reflection_en:
      ...
      },
      {
        ...
        reflection_ko: '나와 다른 사람의 손을, 오늘 잡아볼 수 있겠는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 4,
        text_ko:
          '다름을 건너려면 자비가 필요하다.\n자비는 위에서 내려다보는 동정이 아니다.\n"나도 저러할 수 있었다"는 겸손한 인식이다.',
        text_en:
        ...
        reflection_ko:
          '오늘 누군가를 보며 "나도 저러할 수 있었다"고 느낀 적이 있는가?',
        reflection_en:
      ...
      },
      {
        ...
        reflection_ko: '아직 용서하지 못한 것이 있다면, 그것이 나를 묶고 있지는 않은가?',
        reflection_en:
      ...
      },
      {
        ...
        reflection_ko: '누군가에 대한 판단을 내려놓으면, 무엇이 들리는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 7,
        text_ko:
          '판단 없이 듣다 보면, 경계가 흐려진다.\n나와 너 사이의 벽이 사라지면,\n우리가 같은 바다의 파도였다는 것을 알게 된다.',
        text_en:
        ...
        reflection_ko: '내 옆의 사람과 나는 어떤 바다를 함께 이루고 있는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 8,
        text_ko:
          '같은 바다라는 것을 알면, 한 사람을 향한 사랑이 세상 전체로 퍼진다.\n사랑은 한 곳에서 시작하지만, 거기서 멈추지 않는다.',
        text_en:
        ...
        reflection_ko: '한 사람을 깊이 사랑해본 적이 있는가? 그 사랑이 어디까지 퍼졌는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 9,
        text_ko:
          '세상의 모든 지식을 갖고 있어도, 사랑이 없으면 텅 빈 것이다.\n사랑이 지식에 숨을 불어넣어야, 지식이 살아 움직인다.',
        text_en:
        ...
        reflection_ko: '내가 아는 것들 속에, 사랑이 숨 쉬고 있는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 10,
        text_ko:
          '사랑이 지식보다 앞서는 이유가 있다.\n조건 없는 사랑이야말로 모든 경전이 가리키는 하나의 진리이기 때문이다.\n그 사랑 앞에서, 모든 가르침은 하나가 된다.',
        text_en:
        ...
        reflection_ko: '조건 없이 사랑받았다고 느낀 순간이 있는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 11,
        text_ko:
          '그래서 사랑은 역설이다.\n둘이 하나가 되면서도, 둘로 남아 있다.\n이 말이 머리로 이해되지 않아도 괜찮다.\n사랑 안에 들어가 보면, 그냥 알게 된다.',
        text_en:
        ...
        reflection_ko:
          '사랑 안에서, 하나이면서 나로 남아 있는 순간을 느낀 적이 있는가?',
        reflection_en:
    ...
    verses: [
      {
        ...
        reflection_ko: '지금 놓아야 할 것은 무엇인가? 그것이 떠나면 무엇이 익겠는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 2,
        text_ko:
          '이렇게 무언가 익어가는 동안에도, 매 순간은 작은 탄생이자 작은 죽음이다.\n들숨과 날숨 사이에, 삶 전체가 들어 있다.',
        text_en:
        ...
        reflection_ko: '지금 이 숨이 마지막이라면, 무엇을 하고 싶은가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 3,
        text_ko:
          '그런데 우리는 이 숨을 당연하게 여기며 미룬다.\n영원히 살 것처럼 미루고, 내일 죽을 것처럼 두려워한다.\n그 사이에서 오늘이 빠져나간다.',
        text_en:
        ...
        reflection_ko: '오늘이 빠져나가기 전에, 지금 시작할 수 있는 것은 무엇인가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 4,
        text_ko:
          '오늘을 놓치지 않겠다고 결심하면, 떠나간 사람들도 다르게 보인다.\n그들은 사라진 것이 아니다. 비가 되어 내리고, 바람이 되어 불어온다.',
        text_en:
        ...
        reflection_ko: '떠나간 사람의 바람이 불어올 때, 어디에서 느끼는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 5,
        text_ko:
          '그 바람을 느끼려면, 죽음을 바라볼 줄 알아야 한다.\n죽음을 바라보는 것은 우울한 것이 아니다.\n삶의 윤곽을 선명하게 해주는 빛이다.',
        text_en:
        ...
        reflection_ko: '죽음을 바라볼 때, 지금 이 삶은 어떤 모습으로 보이는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 6,
        text_ko:
          '그 빛 아래에서 보면, 끝은 진짜 끝이 아니다.\n씨앗은 어둠 속에서 깨져야 싹이 튼다.\n끝이라고 느끼는 바로 그 순간이, 시작이다.',
        text_en:
        ...
        reflection_ko: '지금 끝나고 있는 무언가 속에서, 어떤 시작이 보이는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 7,
        text_ko:
          '끝과 시작이 하나라면, 존재 자체가 기적이다.\n수십억 년의 별먼지가 모여 지금의 너가 되었다.',
        text_en:
        ...
        reflection_ko: '별먼지였던 내가 지금 여기 있다는 사실이, 오늘은 얼마나 놀라운가?',
      ...
      },
      {
        ...
        verse: 8,
        text_ko:
          '별먼지가 사람이 되었듯, 삶과 죽음도 떼어놓을 수 없다.\n소리와 침묵처럼, 하나가 없으면 다른 하나도 없다.',
        text_en:
        ...
        reflection_ko: '삶의 소리와 죽음의 침묵 사이에서, 무엇이 들리는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 9,
        text_ko:
          '그 소리와 침묵이 함께이기에, 삶은 덧없어도 가치가 줄지 않는다.\n오히려 더 빛난다.\n운명을 사랑한다는 것은, 이 덧없음까지 사랑한다는 뜻이다.',
        text_en:
        ...
        reflection_ko: '덧없기에 오히려 더 소중하게 느껴지는 것은 무엇인가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 10,
        text_ko:
          '덧없음을 사랑할 수 있다면, 변화도 두렵지 않다.\n사람은 몸에서 마음으로, 마음에서 정신으로, 정신에서 영혼으로 바뀌어가는 존재이다.',
        text_en:
        ...
        reflection_ko: '지금 나는 몸, 마음, 정신, 영혼 중 어디쯤에 있는가?',
        reflection_en:
      ...
      },
      {
        ...
        reflection_ko: '나와 세상 사이의 경계가 사라진다면, 무엇이 남겠는가?',
      ...
      },
      {
        ...
        verse: 12,
        text_ko:
          '경계가 사라진 자리에는 평화가 있다.\n새로 생겨나는 것도 없고, 사라지는 것도 없다.\n지금 이 순간이, 이미 절대적인 평화이다.',
        text_en:
        ...
        reflection_ko: '아무것도 오지 않고 가지 않는다면, 지금 이 순간은 어떤 느낌인가?',
        reflection_en:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    theme: 'practice',
    intro_ko:
      '평화를 알았다면, 이제 그 안에 머무는 법을 배울 차례이다.\n수행은 거창한 것이 아니다. 매 순간 자기 자신에게 돌아오는 것이다.',
    intro_en:
    ...
    verses: [
      {
        ...
        verse: 1,
        text_ko:
          '하루에 5분만 아무것도 하지 않고 앉아 보라.\n할 일을 멈추는 것, 그것이 가장 깊은 수행의 시작이다.',
        text_en:
        ...
        reflection_ko: '오늘 5분, 아무것도 하지 않는 시간을 자신에게 줄 수 있겠는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 2,
        text_ko:
          '고요히 앉아 있으면 무언가가 들려오기 시작한다.\n기도는 말하는 것이 아니라, 듣는 것이다.',
        text_en:
        ...
        reflection_ko: '말을 멈추고 귀를 기울이면, 무엇이 들리는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 3,
        text_ko:
          '들리지 않는 날도 있다. 마음이 흩어지는 날도 있다.\n그래도 다시 앉는 것, 그것이 수행이다. 완벽할 필요는 없다.',
        text_en:
        ...
        reflection_ko: '마음이 흩어진 날, 자신을 다그치지 않고 다시 시작할 수 있는가?',
      ...
      },
      {
        ...
        reflection_ko: '지금 이 자리에서 숨을 한 번 깊이 쉬어 보라. 무엇이 달라지는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 5,
        text_ko:
          '호흡은 앉아 있을 때만의 것이 아니다.\n설거지를 하면서도, 길을 걸으면서도 숨을 느낄 수 있다.\n수행은 특별한 장소에 있지 않다.',
        text_en:
        ...
        reflection_ko: '오늘 가장 평범한 순간에 숨을 한 번 느껴볼 수 있겠는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 6,
        text_ko:
          '일상의 수행은 몸에서 시작된다.\n몸은 마음이 사는 집이다. 집을 돌보지 않으면, 안에 있는 이도 편하지 않다.',
        text_en:
        ...
        reflection_ko: '오늘 내 몸에게 작은 돌봄 하나를 선물할 수 있겠는가?',
      ...
      },
      {
        ...
        verse: 7,
        text_ko:
          '몸을 돌보았다면, 가끔은 밖으로 나가 보라.\n나무는 그냥 서 있는 법을 가르쳐주고, 바람은 놓아주는 법을 보여준다.',
        text_en:
        ...
        reflection_ko: '마지막으로 하늘을 올려다보며 가만히 선 것은 언제인가?',
      ...
      },
      {
        ...
        verse: 8,
        text_ko:
          '자연이 가르쳐주듯, 수행에는 끝이 없다.\n끝이 없다는 것이 아름다운 것이다. 매일이 첫날이다.',
        text_en:
        ...
        reflection_ko: '오늘이 수행의 첫날이라면, 무엇부터 하겠는가?',
        reflection_en:
      ...
      },
      {
        ...
        verse: 9,
        text_ko:
          '매일이 첫날이라면, 많은 것이 필요하지 않다.\n덜어내고, 또 덜어내라. 진짜 풍요는 비울 때 찾아온다.',
        text_en:
        ...
        reflection_ko: '내 삶에서 하나만 덜어낸다면, 무엇을 놓겠는가?',
      ...
      },
      {
        ...
        verse: 10,
        text_ko:
          '비워낸 자리에 누군가가 대신 채워주지는 않는다.\n예수도 대신 기도해주지 않았고, 석가도 대신 명상해주지 않았다.\n이 길은 스스로 걸어야 한다.',
        text_en:
        ...
        reflection_ko: '내 수행을 대신해 줄 사람은 없다는 것을 받아들일 수 있는가?',
        reflection_en:
      ...
      },
      {
        ...
        reflection_ko:
          '지금 이 순간 하고 있는 일을, 온 마음으로 할 수 있는가?',
        reflection_en:
      ...
      },
      {
        ...
        reflection_ko:
          '좋아하는 것에 대한 집착까지도, 내려놓을 준비가 되었는가?',
        reflection_en:
